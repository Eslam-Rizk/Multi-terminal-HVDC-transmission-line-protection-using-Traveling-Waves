...
MODEL              = normal_operation_no_faults
MODULES            = normal_operation_no_faults_acc.c normal_operation_no_faults_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c
MAKEFILE           = normal_operation_no_faults.mk
MATLAB_ROOT        = D:/eslam/programs/MATLAB2018/R2018a
ALT_MATLAB_ROOT    = D:/eslam/programs/MATLAB~2/R2018a
MASTER_ANCHOR_DIR  = 
START_DIR          = D:/eslam/programs/MATLAB2018/HVDC
MATLAB_BIN         = D:/eslam/programs/MATLAB2018/R2018a/bin
ALT_MATLAB_BIN     = D:/eslam/programs/MATLAB~2/R2018a/bin
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 4
TID01EQ            = 0
...
MEX_OPT_FILE       = -f D:/eslam/programs/MATLAB~2/R2018a/rtw/c/tools/LCC-WI~1.XML
OPTIMIZATION_FLAGS = -DNDEBUG
ADDITIONAL_LDFLAGS = 
DEFINES_CUSTOM     = 

#--------------------------- Model and reference models -----------------------
MODELLIB                  = normal_operation_no_faultslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/normal_operation_no_faults \
